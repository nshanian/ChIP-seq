...
/<path_to_working_directory>/align2rawsignal/bin/align2rawsignal -i="/<path_to_working_directory>/step1/FinalAlign/Cnt2H3K18ac_sorted_dedup_filterUnmap_filterChrM_aln.bam" -s="/<path_to_working_directory>/hg38/chr_fasta" -u="/<path_to_working_directory>/hg38/mappability/globalmap_k20tok101" -o="/<path_to_working_directory>/step2/SignalTrackBigWig/Cnt2H3K18ac.bedGraph" -of="bg" -n=5 -l=175 -k=epanechnikov -w=150 -f=0
...
/<path_to_working_directory>/align2rawsignal/bin/align2rawsignal -i="/<path_to_working_directory>/step1/FinalAlign/Prop1H3K18pr_sorted_dedup_filterUnmap_filterChrM_aln.bam" -s="/<path_to_working_directory>/hg38/chr_fasta" -u="/<path_to_working_directory>/hg38/mappability/globalmap_k20tok101" -o="/<path_to_working_directory>/step2/SignalTrackBigWig/Prop1H3K18pr.bedGraph" -of="bg" -n=5 -l=170 -k=epanechnikov -w=150 -f=0
...
/<path_to_working_directory>/align2rawsignal/bin/align2rawsignal -i="/<path_to_working_directory>/step1/FinalAlign/Prop2H3K18pr_sorted_dedup_filterUnmap_filterChrM_aln.bam" -s="/<path_to_working_directory>/hg38/chr_fasta" -u="/<path_to_working_directory>/hg38/mappability/globalmap_k20tok101" -o="/<path_to_working_directory>/step2/SignalTrackBigWig/Prop2H3K18pr.bedGraph" -of="bg" -n=5 -l=160 -k=epanechnikov -w=150 -f=0
...
/<path_to_working_directory>/align2rawsignal/bin/align2rawsignal -i="/<path_to_working_directory>/step1/FinalAlign/Cnt2H4K12ac_sorted_dedup_filterUnmap_filterChrM_aln.bam" -s="/<path_to_working_directory>/hg38/chr_fasta" -u="/<path_to_working_directory>/hg38/mappability/globalmap_k20tok101" -o="/<path_to_working_directory>/step2/SignalTrackBigWig/Cnt2H4K12ac.bedGraph" -of="bg" -n=5 -l=140 -k=epanechnikov -w=150 -f=0
...
/<path_to_working_directory>/align2rawsignal/bin/align2rawsignal -i="/<path_to_working_directory>/step1/FinalAlign/Prop1H4K12pr_sorted_dedup_filterUnmap_filterChrM_aln.bam" -s="/<path_to_working_directory>/hg38/chr_fasta" -u="/<path_to_working_directory>/hg38/mappability/globalmap_k20tok101" -o="/<path_to_working_directory>/step2/SignalTrackBigWig/Prop1H4K12pr.bedGraph" -of="bg" -n=5 -l=170 -k=epanechnikov -w=150 -f=0
...
/<path_to_working_directory>/align2rawsignal/bin/align2rawsignal -i="/<path_to_working_directory>/step1/FinalAlign/Prop2H4K12pr_sorted_dedup_filterUnmap_filterChrM_aln.bam" -s="/<path_to_working_directory>/hg38/chr_fasta" -u="/<path_to_working_directory>/hg38/mappability/globalmap_k20tok101" -o="/<path_to_working_directory>/step2/SignalTrackBigWig/Prop2H4K12pr.bedGraph" -of="bg" -n=5 -l=225 -k=epanechnikov -w=150 -f=0
